...
type TicketCommon struct {
	...
	UploadTime  int64    `json:"upload_time" valid:"required"`  // 上链时间 只计算第一次
}
...
type NodeCommon struct {
	...
	Status     string  `json:"status" valid:"required"`      // 状态
	CreateTime int64   `json:"create_time" valid:"required"` // 创建时间
	UploadTime int64   `json:"upload_time" valid:"required"` // 上链时间
	Source     Address `json:"source" valid:"optional"`      // 数据来源
}
